...
import numpy as np
import torch
from models.invert_model.stylegan_generator import StyleGANGenerator
from models.invert_model.stylegan_encoder import StyleGANEncoder
from models.invert_model.perceptual_model import PerceptualModel
import pytorch_ssim
...
class StyleGANInverter(object):
  ...
  def __init__(self,
               model_name,
               pretrained_weights = './pretrained_models/vgg16.pth',
               learning_rate=1e-2,
               iteration=100,
    ...
    self.F = PerceptualModel(min_val=self.G.min_val, max_val=self.G.max_val,weight_path = pretrained_weights)
